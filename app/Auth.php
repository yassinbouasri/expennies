...
use App\mail\TowFactorAuthEmail;
...
class Auth implements AuthInterface
{
    ...
    public function __construct(
        ...
        private readonly TowFactorAuthEmail $towFactorAuthEmail,
    ...
    public function startLoginWith2FA(UserInterface $user)
    {
        ...
        $this->towFactorAuthEmail->send($this->userLoginCodeService->generate($user));
    }
}
